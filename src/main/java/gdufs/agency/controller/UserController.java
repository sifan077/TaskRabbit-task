...
public class UserController {
    ...
    public Object add(String code, String encryptedData, String iv) {
        ...
        String wxspAppid = "wx37e4b4e9d81bd7d0";  //"wxd5313e0bf7f485d4";
        //小程序的 app secret (在微信小程序管理后台获取)
        String wxspSecret = "382ae9a4211732b855bf84e314105a2e";  //"df0aacd3b50c1e2fc7d8e5cc56029f8a";
        //授权（必填）
    ...
    public @ResponseBody
    String getUser(HttpServletRequest request, HttpServletResponse response) throws Exception {
...
//                + "academy: " + academy + "\n" + "address: " + address + "\n");
    ...
    public void setInfo(HttpServletRequest request, HttpServletResponse response) throws IOException {
        request.setCharacterEncoding("utf-8");
        response.setCharacterEncoding("UTF-8");
        String openId = request.getParameter("openId");
        String avatarUrl = request.getParameter("avatarUrl");
        log.info("{}--------{}", openId, avatarUrl);
        User user = new User();
        user.setAvatarUrl(avatarUrl);
        user.setOpenId(openId);
        PrintWriter pw = response.getWriter();
        if (userService.setAvatarUrl(user) == 1) {
            pw.println("成功");
        } else {
            pw.println("失败");
        }
